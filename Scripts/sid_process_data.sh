...
RScript R/sid_process_data.R analytical.data.dir="$ANALYTICAL_DATA_DIR" baseline.data.dir="$BASELINE_DATA_DIR" output.data.dir="$OUTPUT_DATA_DIR" raw.data.dir="$RAW_DATA_DIR" 2>&1 >/dev/null
if [ "$?" != "0" ]; then
